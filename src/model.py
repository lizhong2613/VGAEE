...
class GCNModelGAN(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero,decoder_act=[tf.nn.sigmoid, tf.nn.sigmoid], **kwargs):
        super(GCNModelGAN, self).__init__(**kwargs)
    ...
    def _build(self):
        ...
        self.structure_reconstructions = InnerProductDecoder(input_dim=FLAGS.hidden2,
                                      act=lambda x: x,
                                      logging=self.logging)(self.structure_decoder_layer1)
        ...
        #softmax 层
        self.sigmod_result = Dense(FLAGS.hidden2,1,self.dropout,tf.nn.sigmoid)(self.z)
...
class GCNModelVAE(Model):
    ...
    def _build(self):
        ...
        # # structure encoder
        # self.hidden1_att = Dense(input_dim=self.input_dim,
        #                      output_dim=FLAGS.hidden1,
        #                      act=tf.nn.relu,
        #                      sparse_inputs=True,
        #                      dropout=self.dropout)(self.inputs)
        # self.hidden1_att = tf.expand_dims(self.hidden1_att, 1)
        # attns = []
        # k = 1
        # for _ in range(k):
        ...
        #                                # act=tf.nn.relu,
        #                                act=lambda x: x,
        #                                out_sz=FLAGS.hidden2 // k)(self.hidden1_att))
        #
        # self.embeddings_s = tf.concat(attns, axis=-1)[0]
        # # self.structure_reconstructions = InnerProductDecoder(input_dim=FLAGS.hidden2,
        # #                                                     act=lambda x: x,
        # #                                       logging=self.logging)(self.embeddings_s)
        #
        #
        #
        # # decoder1
        ...
        #                    logging=self.logging)((self.embeddings_s, self.z))
...
class AnomalyDAE(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero,
        ...
        self.inputs = placeholders['features'] # 输入的特征
        self.input_dim = num_features
        self.features_nonzero = features_nonzero
        self.n_samples = num_nodes
        self.adj = placeholders['adj'] # 连接矩阵
        self.dropout = placeholders['dropout']
        self.decoder_act = decoder_act
        self.build()
    ...
    def _build(self):
        self.hidden1 = Dense(input_dim=self.input_dim,
                             ...
                             act=tf.nn.relu,
                             sparse_inputs=True,
                             dropout=self.dropout)(self.inputs) #输入的特征
